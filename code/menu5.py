...
class Menu5:
    ...
    def __init__(self, player, toggle_menu, questions=None, correct_indices=None):
        ...
        self.questions = [
            ("Quanto é 48/6=?", ["7", "8", "9", "6"], 1),
            ("Quanto é 7*7=?", ["49", "47", "51", "45"], 0),
            ("Quanto é 44+50=?", ["90", "94", "96", "92"], 1),
            ("Qual número que completa o cálculo? 2*[ ]=8", ["2", "4", "6", "8"], 1),
            ("Qual número que completa o cálculo? 22/[ ]=11", ["2", "3", "4", "5"], 0),
            ("Qual número que completa o cálculo? [ ]+16=37", ["19", "20", "21", "22"], 2),
]
